...
```python
from bidu.layers.core import Activation, Dense
...
Activations that are more complex than a simple Theano/TensorFlow function (eg. learnable activations, configurable activations, etc.) are available as [Advanced Activation layers](layers/advanced-activations.md), and can be found in the module `bidu.layers.advanced_activations`. These include PReLU and LeakyReLU.
