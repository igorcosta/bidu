...
```python
from bidu.datasets import cifar10
...
```python
from bidu.datasets import cifar100
...
```python
from bidu.datasets import imdb
...
- __Arguments:__
    ...
    - __path__: if you do have the data locally (at `'~/.bidu/datasets/' + path`), if will be downloaded to this location (in cPickle format).
...
```python
from bidu.datasets import reuters
...
- __Arguments:__
    ...
    - __path__: if you do have the index file locally (at `'~/.bidu/datasets/' + path`), if will be downloaded to this location (in cPickle format).
...
```python
from bidu.datasets import mnist
