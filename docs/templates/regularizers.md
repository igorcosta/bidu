...
- `W_regularizer`: instance of `bidu.regularizers.WeightRegularizer`
- `b_regularizer`: instance of `bidu.regularizers.WeightRegularizer`
- `activity_regularizer`: instance of `bidu.regularizers.ActivityRegularizer`


## Example

```python
from bidu.regularizers import l2, activity_l2
...
```python
bidu.regularizers.WeightRegularizer(l1=0., l2=0.)
```

```python
bidu.regularizers.ActivityRegularizer(l1=0., l2=0.)
```

## Shortcuts

These are shortcut functions available in `bidu.regularizers`.
