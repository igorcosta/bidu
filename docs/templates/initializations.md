...
Initializations define the way to set the initial random weights of bidu layers.
...
You could also use functions from `bidu.initializations` in this way:

```python
from bidu import initializations
