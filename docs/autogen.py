...
- Layers
    About bidu layers
        ...
        explain input_shape
        explain usage on non-bidu tensors
    Core layers
    Convolutional
    Recurrent
    Embeddings
...
from bidu.layers import convolutional
from bidu.layers import pooling
from bidu.layers import local
from bidu.layers import recurrent
from bidu.layers import core
from bidu.layers import noise
from bidu.layers import normalization
from bidu.layers import advanced_activations
from bidu.layers import embeddings
from bidu.layers import wrappers
from bidu import optimizers
from bidu import callbacks
from bidu import models
from bidu.engine import topology
from bidu import objectives
from bidu import metrics
from bidu import backend
from bidu import constraints
from bidu import activations
from bidu import regularizers
from bidu.utils import data_utils
from bidu.utils import io_utils
from bidu.utils import layer_utils
...
def class_to_source_link(cls):
    ...
    link = 'https://github.com/fchollet/bidu/blob/master/' + path + '#L' + str(line)
    return '[[source]](' + link + ')'
