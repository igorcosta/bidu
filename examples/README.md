...
Loads pre-trained word embeddings (GloVe embeddings) into a frozen bidu Embedding layer, and uses it to train a text classification model on the 20 Newsgroup dataset.
...
Demonstrates how to build a variational autoencoder with bidu using deconvolution layers.
