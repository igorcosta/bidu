...
inside of bidu.  Note that the font list may need to be updated
...
class for test/train data and a bidu callback class. Every 10 epochs
...
from bidu.layers.convolutional import Convolution2D, MaxPooling2D
from bidu.layers import Input, Layer, Dense, Activation, Flatten
from bidu.layers import Reshape, Lambda, merge, Permute, TimeDistributed
from bidu.models import Model
from bidu.layers.recurrent import GRU
from bidu.optimizers import SGD
from bidu.utils import np_utils
from bidu.utils.data_utils import get_file
from bidu.preprocessing import image
import bidu.callbacks
...
class TextImageGenerator(bidu.callbacks.Callback):
...
# an internal bidu loss function
...
class VizCallback(bidu.callbacks.Callback):
...
# bidu doesn't currently support loss funcs with extra parameters
