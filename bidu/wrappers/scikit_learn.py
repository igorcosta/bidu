...
class BaseWrapper(object):
    '''Base class for the bidu scikit-learn wrapper.
    ...
    The build_fn should construct, compile and return a bidu model, which
...
class biduClassifier(BaseWrapper):
    '''Implementation of the scikit-learn classifier API for bidu.
    '''
    ...
    def predict_proba(self, X, **kwargs):
        ...
        # Returns
            proba: array-like, shape `(n_samples, n_outputs)`
                ...
                (instead of `(n_sample, 1)` as in bidu).
        '''
...
class biduRegressor(BaseWrapper):
    '''Implementation of the scikit-learn regressor API for bidu.
    '''
