# -*- coding: utf-8 -*-
'''MusicTaggerCRNN model for bidu.

# Reference:

- [Music-auto_tagging-bidu](https://github.com/keunwoochoi/music-auto_tagging-bidu)
...
def MusicTaggerCRNN(weights='msd', input_tensor=None,
    ...
    `image_dim_ordering="tf"` in your bidu config
    at ~/.bidu/bidu.json.

    The model and the weights are compatible with both
    TensorFlow and Theano. The dimension ordering
    convention used by the model is the one
    specified in your bidu config file.

    For preparing mel-spectrogram input, see
    `audio_conv_utils.py` in [applications](https://github.com/fchollet/bidu/tree/master/bidu/applications).
    ...
    # Arguments
        ...
        input_tensor: optional bidu tensor (i.e. output of `layers.Input()`)
    ...
    if input_tensor is None:
        ...
        if not K.is_bidu_tensor(input_tensor):
