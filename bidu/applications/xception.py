...
def Xception(include_top=True, weights='imagenet',
    ...
    You should set `image_dim_ordering="tf"` in your bidu config
    located at ~/.bidu/bidu.json.
    ...
    if K.image_dim_ordering() != 'tf':
        warnings.warn('The Xception model is only available for the '
                      ...
                      'You should set `image_dim_ordering="tf"` in your bidu '
                      'config located at ~/.bidu/bidu.json. '
