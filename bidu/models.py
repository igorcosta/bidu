...
def save_model(model, filepath, overwrite=True):
    ...
    def get_json_type(obj):
        # if obj is a serializable bidu class instance
        # e.g. optimizer, layer
    ...
    f.attrs['bidu_version'] = str(bidu_version).encode('utf8')
    ...
    if hasattr(model, 'optimizer'):
        if isinstance(model.optimizer, optimizers.TFOptimizer):
            warnings.warn(
                ...
                'Prefer using a bidu optimizer instead '
                '(see bidu.io/optimizers).')
        else:
...
class Sequential(Model):
    ...
    # Example
        ...
        ```python
            ...
            # afterwards, bidu does automatic shape inference
            model.add(Dense(32))
    ...
    def add(self, layer):
        ...
        if not self.outputs:
            ...
            Node(outbound_layer=self,
                 ...
                 output_shapes=[self.outputs[0]._bidu_shape])
        else:
            ...
            self.inbound_nodes[0].output_shapes = [self.outputs[0]._bidu_shape]
    ...
    def fit(self, x, y, batch_size=32, nb_epoch=10, verbose=1, callbacks=[],
        ...
        # Arguments
            ...
            callbacks: list of `bidu.callbacks.Callback` instances.
