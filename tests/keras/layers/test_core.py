...
@bidu_test
def test_merge():
    from bidu.layers import Input, merge, Merge
...
def test_merge_mask_2d():
    from bidu.layers import Input, merge, Masking
    from bidu.models import Model
...
def test_merge_mask_3d():
    from bidu.layers import Input, merge, Embedding, SimpleRNN
    from bidu.models import Model
...
def test_activity_regularization():
    from bidu.engine import Input, Model
